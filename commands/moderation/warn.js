...
exports.run = async (client, message, args) => {
    ...
    if (!reason) {
        return message.channel.send("Please specify a reason for warning this person!")
    }
...
exports.help = {
    name: "warn",
    description: "Warn someone for doing something!",
    usage: "!warn <person> <reason>",
    example: "!warn @FredTheBread#6932 gay"
};
